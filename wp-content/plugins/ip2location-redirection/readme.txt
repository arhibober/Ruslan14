...
As the name suggests itself, IP2Location Redirection is one of the most favourite plugins recommended to handle the task of redirection on a website or a custom predefined URL based on country and region geolocated by IP address.
...
No. Please disable the "Cache Plugin" for our plugin to fucntion correctly.
...
1. Redirect visitor from Nigeria to https://google.com.
